...
export class Xia0shiSliderCard extends LitElement {
  ...
  _callService(value) {
    ...
    this.hass.callService(service, 'set_percentage', {
      entity_id: this.config.entity,
      percentage: value
    });
  }
}
customElements.define('xia0shi-slider-card', Xia0shiSliderCard);
